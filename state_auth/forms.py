...
class Auth_Form(forms.Form):
    ...
    Pancard = forms.CharField(max_length=100, widget=forms.TextInput(
        attrs={'placeholder': 'Enter your cardnumber', 'id': 'form21', 'class': 'input'}))
    ...
    phone = forms.CharField(max_length=100, widget=forms.TextInput(
        attrs={'placeholder': 'Enter your phonenumber', 'id': 'form21', 'class': 'input'}))
...
class Third_Form(forms.Form):
    ...
    imports = forms.FloatField(widget=forms.TextInput(
        attrs={'placeholder': 'Enter column imports'}))
    exports = forms.FloatField(widget=forms.TextInput(
        attrs={'placeholder': 'Enter column exports'}))
    production=forms.FloatField(widget=forms.TextInput(
        attrs={'placeholder': 'Enter column production'}))
    imports_mean = forms.FloatField(widget=forms.TextInput(
        attrs={'placeholder': ' imports_mean'}))
    exports_mean = forms.FloatField(widget=forms.TextInput(
        attrs={'placeholder': ' exports_mean'}))
    production_mean = forms.FloatField(widget=forms.TextInput(
        attrs={'placeholder': ' production_mean'}))


class PasswordForm(forms.Form):
    email = forms.EmailField(max_length=60, widget=forms.TextInput(attrs={'placeholder': 'Enter your Email' ,'class':'input'}))
    password1 = forms.CharField(label="New Password",max_length=50,widget=forms.TextInput(attrs={'placeholder': 'Enter your current Pass','id':'form21' ,'class':'input'}))
    password2 = forms.CharField(label="Confirm Password",max_length=50,widget=forms.TextInput(attrs={'placeholder': 'Enter your new Pass','id':'form21' ,'class':'input'}))
